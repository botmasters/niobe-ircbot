...
var servicecmdsModule = {
  ...
  commands: {
    chan: {
      '!ban': {
        level: 70,
        callback: servicecmds.cmdBan
      },
      '!unban': {
        level: 70,
        callback: servicecmds.cmdUnban
      },
      '!sop': {
        level: 70,
        callback: servicecmds.cmdOp
      },
      '!sdeop': {
        level: 70,
        callback: servicecmds.cmdDeop
      },
      '!svoice': {
        level: 70,
        callback: servicecmds.cmdVoice
      },
      '!sdevoice': {
        level: 70,
        callback: servicecmds.cmdDevoice
      }
    },
    ...
    priv: {
      'panic': {
        level: 99,
        callback: servicecmds.cmdPanic
      },
      'dontpanic': {
        level: 99,
        callback: servicecmds.cmdDontPanic
      },
    }
  },
